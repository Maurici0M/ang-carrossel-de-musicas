...
@Component({
  selector: 'app-clone-swiper-classico',
  templateUrl: './clone-swiper-classico.component.html',
  styleUrl: './clone-swiper-classico.component.scss',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CloneSwiperClassicoComponent {
